...
<div class=\"wrap\">
  ...
  <div class=\"panel\">
    ...
    parts.append("""<div class="chip engine-chip" onclick="clearEngines()" title="Clear engine filters">clear</div></div>""")
    ...
    parts.append("""<div class="chip gender-chip" onclick="clearGenders()" title="Clear gender filters">clear</div></div>""")
  ...
  <div class=\"grid\">\n""")
    ...
    for e in entries:
        ...
        title = clean_voice(lang_code, e.get('voice'))
        exists = e['exists']
